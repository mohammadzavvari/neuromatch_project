...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="1",
        help="name of the folder where model is saved",
    )
    parser.add_argument(
        "--episode-length", type=int, default=50, help="steps per episode"
    )
    parser.add_argument(
        "--episode-num", type=int, default=30, help="total number of episode"
    )
